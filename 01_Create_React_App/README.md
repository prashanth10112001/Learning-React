...
| Question                                                                           | Answer                                                                                                                                                                                                                                                    |
| ---------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1. In JSX, what is the difference between lowercase and uppercase component names? | `Lowercase names like 'h1' represent standard DOM tags, while uppercase names like 'Pizza' represent custom React components. Uppercase naming is required by React tools and helps distinguish between native DOM elements and user-created components.` |
| 2. What special consideration must be made for self-closing tags in JSX?           | `In JSX, self-closing tags must explicitly include the closing slash ('/'), even if HTML would consider it valid. This is a strict requirement of JSX to help keep track of tags.s`                                                                       |
